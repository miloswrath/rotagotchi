...
- TypeScript 5.x targeting Chrome 88+ (Manifest V3) + `lottie-web` (existing), `@supabase/supabase-js` (existing), `esbuild` (existing build tool) (007-extension-game-logic)
- `chrome.storage.local` (game state + blacklist), `chrome.storage.session` (tab state, existing) (007-extension-game-logic)
...
## Recent Changes
- 007-extension-game-logic: Added TypeScript 5.x targeting Chrome 88+ (Manifest V3) + `lottie-web` (existing), `@supabase/supabase-js` (existing), `esbuild` (existing build tool)
